            ...
            <div class="ourteam_wrapper">
                <div class="team-1 team">
                    <div class="team_member">
                        <img src="\test\team\rock.jpg" alt="rock.jpg">
                        <p>Mr:Ajay Kumar Yadav(CEO)</p>
                    </div>
                    <div class="team_member">
                        <img src="\test\team\jaj.jpg" alt="jaj.jpg">
                        <p>Mr: Jajwlyaman Gautam(Marketing manager)</p>
                    </div>
                </div>
                <div class="team-2 team">
                    <div class="team_member">
                        <img src="\test\team\driver.jpg" alt="driver.jpg">
                        <p>Mr:mad(Driver)</p>
                    </div>
                    <div class="team_member">
                        <img src="\test\team\new.jpg" alt="new.jpg">
                        <p>Ronald Weasly(Driver)</p>
                    </div>
                </div>
